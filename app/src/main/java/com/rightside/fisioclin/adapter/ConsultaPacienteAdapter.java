...
public class ConsultaPacienteAdapter extends RecyclerView.Adapter<ConsultaPacienteAdapter.ViewHolder>  {
    private List<Consulta> consultas = new ArrayList<>();
    private Context context;

    public ConsultaPacienteAdapter(Context context) {
        this.context = context;
    }

    @NonNull
    @Override
    public ConsultaPacienteAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_item_consulta_medico, parent, false);
        return new ConsultaPacienteAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ConsultaPacienteAdapter.ViewHolder holder, int position) {
